...
function initDB(m, client) {
  ...
  settings.id ??= '120363426781015568@newsletter'
  settings.nameid ??= "𝓚𝓪𝓸𝓻𝓾𝓴𝓸-𝓜𝓓"
  settings.type ??= 'Owner'
  settings.link ??= 'https://api.stellarwa.xyz'
  settings.banner ??= 'https://files.catbox.moe/hl6f9j.jpg'
  settings.icon ??= 'https://files.catbox.moe/hl6f9j.jpg'
  settings.currency ??= 'Yenes'
  settings.namebot ??= 'Kaoruko-MD'
  settings.botname ??= 'Kaoruko Waguri'  
  settings.owner ??= ''
